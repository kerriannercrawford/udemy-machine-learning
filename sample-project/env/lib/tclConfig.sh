...
# installed.
TCL_PREFIX='/Users/kerricrawford/udemy/machine-learning/sample-project/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/kerricrawford/udemy/machine-learning/sample-project/env'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/kerricrawford/udemy/machine-learning/sample-project/env/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_c011255d-355d-4e10-9d06-2a364b791019h2p45nxx/croots/recipe/tk_1654088770111/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/Users/kerricrawford/udemy/machine-learning/sample-project/env=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Users/kerricrawford/udemy/machine-learning/sample-project/env/include -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/kerricrawford/udemy/machine-learning/sample-project/env/lib -L/Users/kerricrawford/udemy/machine-learning/sample-project/env/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/kerricrawford/udemy/machine-learning/sample-project/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/kerricrawford/udemy/machine-learning/sample-project/env/include'
...
TCL_PACKAGE_PATH='{/Users/kerricrawford/udemy/machine-learning/sample-project/env/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/kerricrawford/udemy/machine-learning/sample-project/env/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/kerricrawford/udemy/machine-learning/sample-project/env/lib/libtclstub8.6.a'
